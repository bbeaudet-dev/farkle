...
describe('Game State', () => {
  describe('createInitialGameState', () => {
    ...
    it('should work with High Roller dice set', () => {
      ...
      expect(gameState.diceSet).toHaveLength(6);
      expect(gameState.diceSetConfig.name).toBe('High Roller');
    ...
    it('should work with Low Baller dice set', () => {
      ...
      expect(gameState.diceSet).toHaveLength(6);
      expect(gameState.diceSetConfig.name).toBe('Low Baller');
      expect(gameState.diceSetConfig.startingMoney).toBe(15);
      expect(gameState.diceSetConfig.charmSlots).toBe(3);
      expect(gameState.diceSetConfig.consumableSlots).toBe(2);
    ...
    it('should work with Luxury dice set (fewer than 6 dice)', () => {
      ...
      expect(gameState.diceSetConfig.name).toBe('Luxury');
      expect(gameState.diceSetConfig.startingMoney).toBe(15);
      expect(gameState.diceSetConfig.charmSlots).toBe(3);
      expect(gameState.diceSetConfig.consumableSlots).toBe(2);
    ...
    it('should work with Random dice set (random configuration)', () => {
      ...
      expect(gameState.diceSetConfig.charmSlots).toBeLessThanOrEqual(5);
      expect(gameState.diceSetConfig.consumableSlots).toBeGreaterThanOrEqual(0);
      expect(gameState.diceSetConfig.consumableSlots).toBeLessThanOrEqual(3);
    });
    ...
    it('should work with all predefined dice sets', () => {
      ...
      staticDiceSets.forEach(diceSet => {
        ...
        expect(gameState.diceSetConfig.name).toBe(diceSet.name);
        expect(gameState.diceSetConfig.startingMoney).toBe(diceSet.startingMoney);
        expect(gameState.diceSetConfig.charmSlots).toBe(diceSet.charmSlots);
        expect(gameState.diceSetConfig.consumableSlots).toBe(diceSet.consumableSlots);
      });
    });
